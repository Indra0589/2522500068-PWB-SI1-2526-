  ...
  <section id="contact">
      ...
      <form action="ulangan.php" method="POST">
        ...
        <label for="txtnim"><span>NIM:</span>
          <input type="Nim" id="txtnim" name="txtnim" placeholder="ubah." required autocomplete="nim">
        </label>

        <label for="txtnamalengkap"><span>Nama Lengkap:</span>
          <input type="Nama" id="txtnamalengkapanda" name="txtnamalengkapanda" placeholder="ubah." required autocomplete="nama">
        </label>
        ...
        <label for="txthobi"><span>Hobi:</span>
          <input type="hobi" id="txthobianda" name="txthobianda" placeholder="ubah" required autocomplete="email">
        </label>
